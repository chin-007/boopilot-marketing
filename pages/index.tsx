...
// --- NOTE: You must have these components in your Vercel repo! ---
// If you don't, you need to copy them over or replace them with standard HTML tags.
...
// Lazy-loaded Testimonials (Ensure this exists in Vercel too)
...
function BillionDollarAITerminal() {
  ...
  useEffect(() => {
    ...
    const typeInterval = setInterval(() => {
      ...
      if (charIndex >= currentText.length) {
        ...
        setTimeout(() => setPhase('generating'), 800); // Pause before hitting generate
      }
    }, 45); // Typing speed
  ...
  useEffect(() => {
    ...
    if (phase === 'done') {
      // Hold the "Boom! It's done" screen, then loop to next prompt
  ...
  return (
    <div className="relative w-full aspect-[4/3] md:aspect-[21/9] bg-[#030408] rounded-2xl md:rounded-[2rem] border border-white/10 shadow-[0_40px_100px_-20px_rgba(99,102,241,0.4)] overflow-hidden flex flex-col group">
      ...
      <div className="flex-1 relative flex items-center justify-center p-4 md:p-8 overflow-hidden pb-20 md:pb-32">
        ...
        {/* PHASE 1: GENERATING (Neural Network Visual) */}
        {phase === 'generating' && (
        ...
        {/* PHASE 2: DONE (Cinematic Results) */}
        {phase === 'done' && (
          <div className="w-full h-full flex flex-col items-center justify-center animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out z-10">
            ...
            {/* SCENARIO 2: PUBLISH OMNICHANNEL */}
...
// ─── THE "SILICON VALLEY MONSTER" VALUE ENGINE ───
function SiliconValleyValueEngine() {
  return (
    <section id="comparison" className="py-20 md:py-32 px-4 md:px-6 bg-[#fafafa] relative z-10 border-b border-slate-200 overflow-hidden">
      {/* Background effects */}
      <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(16,185,129,0.08),rgba(255,255,255,0))] pointer-events-none"></div>

      <div className="max-w-[1200px] mx-auto relative z-10">
        <div className="text-center mb-16 md:mb-24">
          <Badge className="bg-emerald-100 text-emerald-700 border-0 px-4 py-1.5 text-[10px] md:text-xs font-black mb-6 rounded-full uppercase tracking-widest shadow-sm">
            The Unfair Advantage
          </Badge>
          <h2 className="text-4xl md:text-5xl font-black tracking-tighter text-slate-950 mb-4">Boopilot vs The Old Way</h2>
          <p className="text-slate-600 font-bold text-lg max-w-2xl mx-auto">While you manually post, reply, and chase leads — your competitors are automating everything. Here's what that gap actually costs you.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          {/* Left Card - The Old Way */}
          <Card className="p-8 md:p-12 rounded-[2rem] md:rounded-[2.5rem] bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all duration-500 flex flex-col h-full">
            <div className="flex justify-between items-start mb-8">
              <div>
                <Badge className="bg-slate-100 text-slate-700 border-0 px-3 py-1 text-[9px] md:text-xs font-black mb-4 rounded-full uppercase tracking-widest">The Old Way</Badge>
                <h3 className="text-2xl md:text-3xl font-black tracking-tighter text-slate-950">THE PAINFUL TRUTH</h3>
              </div>
              <Clock className="w-8 h-8 md:w-10 md:h-10 text-slate-400" />
            </div>
            <p className="text-slate-600 font-bold mb-8 flex-grow">This is what running your business marketing looks like right now. And it's quietly destroying your growth.</p>
            <ul className="space-y-4 text-sm font-extrabold text-slate-700">
              <li className="flex items-start gap-3"><X className="w-5 h-5 md:w-6 md:h-6 text-red-400 shrink-0 bg-red-500/10 rounded-full p-1 mt-0.5" /> <span>6+ hours every week creating content that gets forgotten by tomorrow</span></li>
              <li className="flex items-start gap-3"><X className="w-5 h-5 md:w-6 md:h-6 text-red-400 shrink-0 bg-red-500/10 rounded-full p-1 mt-0.5" /> <span>Paying an agency $800/month and having zero idea what they actually do</span></li>
              <li className="flex items-start gap-3"><X className="w-5 h-5 md:w-6 md:h-6 text-red-400 shrink-0 bg-red-500/10 rounded-full p-1 mt-0.5" /> <span>Leads sitting in DMs going cold while you're busy running your business</span></li>
              <li className="flex items-start gap-3"><X className="w-5 h-5 md:w-6 md:h-6 text-red-400 shrink-0 bg-red-500/10 rounded-full p-1 mt-0.5" /> <span>Tracking leads in a spreadsheet that's already 3 days out of date</span></li>
              <li className="flex items-start gap-3"><X className="w-5 h-5 md:w-6 md:h-6 text-red-400 shrink-0 bg-red-500/10 rounded-full p-1 mt-0.5" /> <span>Waking up to 47 unanswered comments and DMs that could have been customers</span></li>
            </ul>
          </Card>

          {/* Right Card - Boopilot */}
          <Card className="p-8 md:p-12 rounded-[2rem] md:rounded-[2.5rem] bg-gradient-to-br from-emerald-50 to-cyan-50 border border-emerald-200 shadow-lg hover:shadow-xl transition-all duration-500 flex flex-col h-full ring-2 ring-emerald-500/20">
            <div className="flex justify-between items-start mb-8">
              <div>
                <Badge className="bg-emerald-100 text-emerald-700 border-0 px-3 py-1 text-[9px] md:text-xs font-black mb-4 rounded-full uppercase tracking-widest">Boopilot AI</Badge>
                <h3 className="text-2xl md:text-3xl font-black tracking-tighter text-slate-950">THE NEW REALITY</h3>
              </div>
              <Zap className="w-8 h-8 md:w-10 md:h-10 text-emerald-500" />
            </div>
            <p className="text-slate-600 font-bold mb-8 flex-grow">While you sleep, eat, and run your business — Boopilot is working. Every lead captured. Every post published. Every reply sent.</p>
            <ul className="space-y-4 text-sm font-extrabold text-slate-700">
              <li className="flex items-start gap-3"><Check className="w-5 h-5 md:w-6 md:h-6 text-emerald-400 shrink-0 bg-emerald-500/10 rounded-full p-1 mt-0.5" /> <span>30 days of content — AI visuals, captions, hashtags — created and scheduled in under 3 minutes</span></li>
              <li className="flex items-start gap-3"><Check className="w-5 h-5 md:w-6 md:h-6 text-emerald-400 shrink-0 bg-emerald-500/10 rounded-full p-1 mt-0.5" /> <span>Every DM and comment gets an instant intelligent reply and drops straight into your CRM</span></li>
              <li className="flex items-start gap-3"><Check className="w-5 h-5 md:w-6 md:h-6 text-emerald-400 shrink-0 bg-emerald-500/10 rounded-full p-1 mt-0.5" /> <span>Your Meta ads created, published, and tracked from one dashboard — no Ads Manager confusion</span></li>
              <li className="flex items-start gap-3"><Check className="w-5 h-5 md:w-6 md:h-6 text-emerald-400 shrink-0 bg-emerald-500/10 rounded-full p-1 mt-0.5" /> <span>Google Business reviews auto-replied to, professionally, within seconds of posting</span></li>
              <li className="flex items-start gap-3"><Check className="w-5 h-5 md:w-6 md:h-6 text-emerald-400 shrink-0 bg-emerald-500/10 rounded-full p-1 mt-0.5" /> <span>Every lead gets followed up by WhatsApp, email, and call — tracked in real time</span></li>
            </ul>
          </Card>
        </div>
      </div>
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        ...
        <div className="relative w-full max-w-6xl mx-auto bg-[#050505] rounded-[2rem] md:rounded-[3rem] border border-slate-800 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.4)] flex flex-col md:flex-row overflow-hidden group">
          ...
          <div className="flex-1 p-8 md:p-16 relative overflow-hidden">
            ...
            {/* Red Rain Particles (Bleeding Cash) */}
            {[...Array(8)].map((_, i) => (
          ...
          <div className="flex-1 p-8 md:p-16 relative overflow-hidden border-t md:border-t-0 border-white/10 md:border-none">
            ...
            {/* Green Matrix Particles (Rising Growth) */}
            {[...Array(8)].map((_, i) => (
...
export default function Home() {
  ...
  // Mute logic for Video sections below
  ...
  // Use a simple window.location handler for Vercel decoupled routing
    ...
    <div className={`min-h-screen bg-[#fafafa] font-sans selection:bg-indigo-100 selection:text-indigo-900 overflow-x-hidden text-slate-900 ${!animationsEnabled ? 'no-animations' : ''}`}>
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-0 px-4 md:px-6 text-center z-10 hero-cinematic-bg border-b border-slate-800/50">
        ...
        <div className="max-w-[1100px] mx-auto relative flex flex-col items-center z-10">
          ...
          {/* THE NEW INTERACTIVE AI TERMINAL HERO */}
        ...
        <div className="max-w-[1200px] mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6">
            ...
            <div className="bento-card col-span-1 md:col-span-12 lg:col-span-4 rounded-[2rem] p-6 md:p-8 relative overflow-hidden group flex flex-col">
              ...
              {/* Hyper-Responsive Mobile/Desktop Video Stack */}
            ...
            {/* ROW 2: Distribution (4), Ads (4), CRM (4) */}
            ...
            {/* ROW 3: Automations & Auto-Responder (12 cols) */}
      ...
      {/* --- 7. THE SILICON VALLEY PRICING MATRIX --- */}
      <section id="pricing" className="py-24 md:py-32 px-4 md:px-6 relative z-10 bg-[#fafafa] border-b border-slate-200 overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto items-center">
            ...
            {/* ⚪ THE STARTER PLAN (Clean, Apple-Minimalist) */}
            ...
            {/* ⚫ THE PRO PIPELINE (The Silicon Valley Monster) */}
            <div className="w-full relative group transform lg:scale-105 z-20 mt-4 lg:mt-0">
              ...
              <Card className="p-8 md:p-12 rounded-[2rem] md:rounded-[2.5rem] bg-[#050505] text-white border-0 shadow-[0_0_80px_rgba(99,102,241,0.3)] relative flex flex-col h-full overflow-hidden">
                ...
                {/* Sleek Hypnotic Button built directly in */}
      ...
      <section className="py-20 md:py-32 px-4 md:px-6 relative z-10 bg-[#02040a] border-y border-white/5 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          {/* CTA 3: Bottom Footer (PERMANENTLY ACTIVE) */}
